  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        // ✅ глушим warning по умолчанию (пользовательский проп переопределит ниже, если передан)
      ...
      >
        ...
        {/* close button без белых колец/подсветки */}
        <SheetPrimitive.Close
          className="absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100
                     focus:outline-none focus:ring-0 focus:ring-offset-0 disabled:pointer-events-none"
        >
