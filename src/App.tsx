  ...
  return (
    <section className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
      <p className="inline-flex items-center gap-2 rounded-full bg-emerald-400/15 px-3 py-1 text-xs font-semibold text-emerald-300">
        Партнёрские ссылки раскрыты · 18+
      </p>
      <h1 className="mt-3 text-3xl font-extrabold">Топ лицензированных казино для новичков</h1>
      <p className="mt-2 text-slate-300">
        Сравниваем лицензии, скорость выплат и условия бонусов. Никаких «чудо-стратегий».
      </p>

      <ul className="mt-4 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
        <CasinoCard name="Brand A" rating={4.6} license="MGA" payout="0–24 ч" methods="Карты, USDT" link="#AFFILIATE_LINK_A" />
        <CasinoCard name="Brand B" rating={4.4} license="Curacao" payout="1–48 ч" methods="Карты, E-wallet" link="#AFFILIATE_LINK_B" />
        <CasinoCard name="Brand C" rating={4.2} license="Curacao" payout="1–72 ч" methods="Карты, Крипто" link="#AFFILIATE_LINK_C" />
      </ul>
    </section>
  );
}
