...
<button
  type="button"
  className="chip-close inline-flex h-5 w-5 items-center justify-center rounded-full hover:bg-transparent focus:outline-none focus-visible:outline-none active:bg-transparent"
  onClick={() => remove(id)}
